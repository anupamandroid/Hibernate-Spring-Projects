...
<div class="container">
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								...
								<div class="text-right">
									<br>
									<button type="button" data-toggle="modal" data-target="#newCategoryModal" class="btn btn-warning btn-sm">Add Category</button>
								</div>
								</c:if>
							</div>
						</div>
	...
	<div class="modal fade" id="newCategoryModal" role="dialog" tabindex="-1">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<!-- Category Form -->
					<sf:form id="categoryForm" class="form-horizontal" action="${contextRoot}/manage/category" method="POST" modelAttribute="category">
						<div class="form-group">
